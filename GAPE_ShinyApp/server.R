...
## for browsing the compendium
  ...
  output$instruction<-renderUI({
    ...
    {
      HTML("<h3 style=\"text-align: center;\"><strong>GAPE user guide&nbsp;</strong></h3>
<h4><strong>GAPE is a user-friendly Shiny App allows the user to investigate differential gene expression and gene set enrichment among auto-annotated <em>Pseudomonas aeruginosa</em> and <em>Escherichia coli</em> transcriptomic datasets.</strong></h4>
           ...
           <h4><strong>*GAPE is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY.</strong></h4>
